<template>
    <div>
        ...
        <div class="echarts">
            <IEcharts :option="bar_radom" :loading="loading" @ready="onReady" @click="onClick"></IEcharts>
            <el-button :plain="true" type="success" @click="doRandom">Random</el-button>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        doRandom() {
            ...
            that.bar_radom.series[0].data = data;
        },
        onReady(instance) {
