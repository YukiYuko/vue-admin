<template>
    <div class="sidebar">
        <div class="person">
            <div class="logo"><img src="../../assets/bilibili.png" alt="bilibili"></div>
            <div class="admin">
                <img src="../../assets/touxiang.jpg" alt="bilibili">
                <h2>Yukiko</h2>
                <p>18683370859</p>
            </div>
        </div>
...
export default {
    ...
    created(){
        // 测试能否正常获取数据
        //ajax.Get('api/news/latest').then((data)=>console.log(data));
    }
}
</script>
